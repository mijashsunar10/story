                                ...
                                <?php for($i=0;$i<10;$i++) { ?>
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <div class="product__item">
                                            {{-- @if ($story->image) --}}
                                            {{-- <div class="product__item__pic set-bg" data-setbg="{{asset('uploads/' . $story->image)}}"> --}}
                                            <div class="product__item__pic set-bg" data-setbg="img/friends.jpg">
                ...
                {{-- @endforeach --}}
                    ...
                    <div class="popular__product">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="img/sidebar/tv-3.jpg">
                                        <div class="ep">18 / 18</div>
                                        <div class="comment"><i class="fa fa-comments"></i> 11</div>
                                        <div class="view"><i class="fa fa-eye"></i> 9141</div>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    ...
                                    <h5><a href="#">Boruto: Next Generation Naruto</a></h5>
                                </div>
                            </div>
                        </div>
