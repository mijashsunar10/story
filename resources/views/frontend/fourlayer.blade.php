                                ...
                                @forelse ($category->storyDetails as $story)
                                    <div class="col-lg-3 col-md-6 col-sm-12">
                                        <div class="product__item">
                                            @if ($story->image)
                                                <div class="product__item__pic" style="background-image: url('{{ asset('uploads/' . $story->image) }}');"
                                            ...
                                            <div class="modal-content" style="background:whitesmoke">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card shadow-sm">
                                                        <div class="row g-0">
                                                            <div class="col-md-4">
                                                                <img src="{{ asset('uploads/' . $story->image) }}" class="img-fluid rounded-start" alt="Story Image">
                                                            </div>
                                                            <div class="col-md-8">
